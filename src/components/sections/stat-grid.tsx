  ...
  return (
    <ul className="grid grid-cols-1 gap-x-10 gap-y-7 sm:grid-cols-2">
      {stats.map((stat, i) => (
        <li
          key={i}
          className="flex flex-col gap-3 border-t border-cs-ink/80 pt-[17px]"
        >
          <p className="font-heading text-[32px] font-semibold tracking-[-0.03em] text-cs-ink sm:text-[46px]">
            {stat.value}
          </p>
