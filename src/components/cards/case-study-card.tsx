    ...
    >
      <div className="relative aspect-[1118/408] w-full overflow-hidden">
        <Image
          ...
          className="object-cover transition-transform duration-[var(--duration-base)] ease-[var(--ease-out)] group-hover/card:scale-[1.02] motion-reduce:group-hover/card:scale-100"
        />
      </div>
